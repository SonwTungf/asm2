                    ...
                    <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50"
                                src="{{$_ENV['ASSETS_ADMIN']}}img/avatar/avatar-1.png" alt="avatar">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50"
                                src="{{$_ENV['ASSETS_ADMIN']}}img/avatar/avatar-2.png" alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50"
                                src="{{$_ENV['ASSETS_ADMIN']}}img/avatar/avatar-3.png" alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50"
                                src="{{$_ENV['ASSETS_ADMIN']}}img/avatar/avatar-4.png" alt="avatar">
                            <div class="media-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row pb-2">
                        ...
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="{{$_ENV['ASSETS_ADMIN']}}img/avatar/avatar-4.png"
                        ...
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="{{$_ENV['ASSETS_ADMIN']}}img/avatar/avatar-1.png"
                        ...
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="{{$_ENV['ASSETS_ADMIN']}}img/avatar/avatar-2.png"
                    ...
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <div class="text-muted text-small"><span class="text-primary"><i
                                        class="fas fa-caret-up"></i></span> 48%
                            </div>
                        </div>
                        <div class="col text-center">
                            ...
                            <div class="text-muted text-small"><span class="text-primary"><i
                                        class="fas fa-caret-up"></i></span> 26%
                            </div>
                        </div>
                        <div class="col text-center">
                            ...
                            <div class="text-muted text-small"><span class="text-danger"><i
                                        class="fas fa-caret-down"></i></span> 14%
                            </div>
                        </div>
                        <div class="col text-center">
                        ...
                        <div class="col text-center">
                            ...
                            <div class="text-muted text-small"><span class="text-primary"><i
                                        class="fas fa-caret-up"></i></span> 5%
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="summary-item">
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <a href="#">
                                        <img class="mr-3 rounded" width="50"
                                            src="{{$_ENV['ASSETS_ADMIN']}}img/products/product-1-50.png" alt="product">
                                    </a>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <a href="#">
                                        <img class="mr-3 rounded" width="50"
                                            src="{{$_ENV['ASSETS_ADMIN']}}img/products/product-2-50.png" alt="product">
                                    </a>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <a href="#">
                                        <img class="mr-3 rounded" width="50"
                                            src="{{$_ENV['ASSETS_ADMIN']}}img/products/product-3-50.png" alt="product">
                                    </a>
                                    <div class="media-body">
                ...
                <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                        ...
                        <li class="media">
                            ...
                            <img class="mr-3 rounded-circle" width="50"
                                src="{{$_ENV['ASSETS_ADMIN']}}img/avatar/avatar-5.png" alt="avatar">
                            <div class="media-body">
...
@section('javascript')
    <script src="{{ $_ENV['ASSETS_ADMIN'] }}js/page/index-0.js"></script>
@endsection